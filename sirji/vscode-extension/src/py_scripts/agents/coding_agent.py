...
class CodingAgentRunner:
    ...
    def process_input_file(self, input_file_path, conversations):
        ...
        if not conversations:
            ...
            if last_action in [ActionEnum.EXECUTE_COMMAND.name, ActionEnum.RUN_SERVER.name, ActionEnum.CREATE_FILE.name, ActionEnum.INSTALL_PACKAGE.name, ActionEnum.READ_FILES.name, ActionEnum.READ_DIR.name, ActionEnum.READ_DIR_STRUCTURE.name]:
